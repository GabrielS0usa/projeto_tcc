...
import com.projeto.tcc.dto.GeminiReportResponseManual;

@Service
public class GeminiServiceManual {

    private static final Logger logger = LoggerFactory.getLogger(GeminiServiceManual.class);
    ...
    private final DailyDataAggregatorManual dailyDataAggregator;
    private final ObjectMapper objectMapper;

    @Autowired
    public GeminiServiceManual(RestTemplate restTemplate, DailyDataAggregatorManual dailyDataAggregator, ObjectMapper objectMapper) {
        this.restTemplate = restTemplate;
        this.dailyDataAggregator = dailyDataAggregator;
        this.objectMapper = objectMapper;
    }

    public GeminiReportResponseManual generateDailyReport(String userId, LocalDate date) {
        ...
        DailyDataBundleManual dailyData = dailyDataAggregator.aggregateDailyData(userId, date);
    ...
    private String createComprehensivePrompt(DailyDataBundleManual data) {
    ...
    private GeminiReportResponseManual parseGeminiResponse(String rawResponse) {
        try {
            // Try to parse as JSON first
            JsonNode jsonNode = objectMapper.readTree(rawResponse);

            GeminiReportResponseManual response = GeminiReportResponseManual.builder()
            ...
            return GeminiReportResponseManual.builder()
    ...
    public String generateReport(Long userId, LocalDate startDate, LocalDate endDate) {
        ...
        try {
            GeminiReportResponseManual response = generateDailyReport(userId.toString(), startDate);
    ...
    private String formatLegacyResponse(GeminiReportResponseManual response) {
