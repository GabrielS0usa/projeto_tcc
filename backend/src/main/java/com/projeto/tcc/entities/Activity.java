...
public class Activity {
	...
	public MedicationTask getMedicationTaskOrigin() {
		return medicationTaskOrigin;
	}

	public void setMedicationTaskOrigin(MedicationTask medicationTaskOrigin) {
		this.medicationTaskOrigin = medicationTaskOrigin;
	}
	...
	public Double calculateEfficiency() {
		if (value == null || duration == null || duration.isZero())
			return 0.0;
