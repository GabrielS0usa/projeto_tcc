...
public class PhysicalActivityEntity {
	...
	public PhysicalActivityEntity(Long id, User user, String activityType, String activityName, LocalDateTime date,
			Integer durationMinutes, Integer caloriesBurned, String notes, Integer intensityLevel) {
		this.id = id;
		this.user = user;
